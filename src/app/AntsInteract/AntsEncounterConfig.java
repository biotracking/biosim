...
import app.AntsHunt.FlyController;
...

{
	...
	public int numagents = 50; // ant(predator) number constant
	...
	public void start() {
		...
		for (double i = xoMin - this.obstacleRadius/2; i <= xoMax
				+ this.obstacleRadius/2; i = i + 0.001) {
			locationX = i;
		...
		for (double i = yoMin - this.obstacleRadius/2; i <= yoMax
				+ this.obstacleRadius/2; i = i + 0.001) {
