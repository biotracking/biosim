...
public class v_Closest_i extends NodeVec2 {
	/**
	 ...
	 *            scan.
	 */
	public v_Closest_i(int type, AbstractRobot ab)// NodeVec2Array im1)
	{
		if (DEBUG)
	...
	public Vec2 Value(double timestamp) {
		...
		// System.out.print("v_Closest_i: "+closestType+"\t"+last_val.x+"\t"+last_val.y+"\n");
