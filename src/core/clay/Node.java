...
/**
 * The basic unit for constructing behaviors in Clay. Nodes may have complex
 * constructors - indicating which other nodes are embedded within them. This is
...
public class Node {
	...
	/**
	 * Begins a new trial. This is implemented with an empty method, so that
	 * classes that extend Node may choose to ignore it.
	 */
