...
public class CircularBufferEnumeration implements Enumeration, Cloneable,
		Serializable {
	/**
	 ...
	 * 
	 * @param cb
	 *            CircularBuffer, the buffer to enumerate.
	 */
	...
	public synchronized Object nextElement() throws NoSuchElementException {
		...
		position++;
		if (position >= buffer.buf_size)
			position = 0;
		return (retval);
	}

	/**
	 * Returns the next element matching the requested class. Implicitly
	 * consumes other types of elements.
	 * 
	 * @return the next element of this enumeration.
	 */
	...
	public static void main(String[] args) {
		...
		CircularBufferEnumeration cbe = new CircularBufferEnumeration(cb);
		for (int i = 0; i < 5; i++) {
