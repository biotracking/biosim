...
/**
 * A class for manipulating 2d vectors. Both polar and cartesian components are
 * always available. The fields x, y, t (theta) and r are directly available for
 * reading, but you should <B> never </B> set them directly. Use setx, sety,
 * sett and setr instead. This (non OO) approach was chosen deliberately for
 * speed reasons; no whining.
 * <P>
 * +x is right, +y is up. t is in radians with t=0 in the +x direction and t =
 * PI in the -r direction, increasing CCW.
 * <P>
...
public class Vec2 implements Cloneable, Serializable {
	...
	/**
	 * The x component of the cartesian view of the vector; <B>never</B> set
	 * directly, use setx instead.
	 * 
	 * @see Vec2#setx
	 */
	public double x = 1;
	...
	/**
	 * The y component of the cartesian view of the vector; <B>never</B> set
	 * directly, use sety instead.
	 * 
	 * @see Vec2#sety
	 */
	public double y = 0;
	...
	/**
	 * The theta component of the polar view of the vector; <B>never</B> set
	 * directly, use sett instead.
	 * 
	 * @see Vec2#sett
	 */
	public double t = 0;
	...
	/**
	 * The r component of the polar view of the vector; <B>never</B> set
	 * directly, use setr instead.
	 * 
	 * @see Vec2#setr
	 */
	public double r = 1;
	 ...
	 * 
	 * @param rot
	 *            how many radians to rotate, CCW is positive.
	 */
	...
	/**
	 * Provides info on which octant (0-7) the vector lies in. 0 indicates 0
	 * radians +- PI/8 1-7 continue CCW.
	 * 
	...
	/**
	 * Provides info on which quadrant (0-3) the vector lies in. 0 indicates 0
	 * radians +- PI/4 1-3 continue CCW.
	 * 
	...
	public static void main(String[] args) {
		...
		temp1.sett(0);
		for (int i = 0; i < 16; i++) {
			System.out.println("t =" + temp1.t + " quad =" + temp1.quadrant()
					+ " octant=" + temp1.octant());
